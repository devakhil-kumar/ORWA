// features/contactSlice.js (or any name you prefer)

import { createSlice, createAsyncThunk } from '@reduxjs/toolkit';
import { ContactusService } from '../../apis/service'; // adjust path as needed

// Async Thunk for Contact Us
...
const contactSlice = createSlice({
  ...
  initialState,
  reducers: {
    // Optional: reset state after showing message
